...
CATALOG_ROWS = [
    ...
    {
        "dataset_id": "clms_evapotranspiration",
        "source_name": "CLMS evapotranspiration products",
        "provider": "Copernicus Land Monitoring Service",
        "api_dataset": "clms_evapotranspiration",
        "temporal_resolution": "10-daily/monthly",
        "profile": "hydro",
        "output_folder": "catalog_only",
        "variables": "evapotranspiration; reference_evapotranspiration",
        "why_relevant": "Reservoir and crop-water loss cross-check when ERA5-Land is not enough.",
        "notes": "Catalog entry only for now; no direct fetch path is wired in the Python dataloader.",
    },
    {
        "dataset_id": "clms_dynamic_land_cover",
        "source_name": "CLMS global dynamic land cover",
        "provider": "Copernicus Land Monitoring Service",
        "api_dataset": "clms_dynamic_land_cover",
        "temporal_resolution": "annual",
        "profile": "hydro",
        "output_folder": "catalog_only",
        "variables": "land_cover_class; cropland_fraction",
        "why_relevant": "Future irrigated-area and crop-demand attribution.",
        "notes": "Catalog entry only for now; custom/agriculture sources currently provide simulator inputs.",
    },
    {
        "dataset_id": "clms_water_bodies",
        "source_name": "CLMS water bodies",
        "provider": "Copernicus Land Monitoring Service",
        "api_dataset": "clms_water_bodies",
        "temporal_resolution": "monthly",
        "profile": "hydro",
        "output_folder": "catalog_only",
        "variables": "water_extent; water_occurrence",
        "why_relevant": "Reservoir/wetland surface-area sanity checks.",
        "notes": "Catalog entry only for now; surface area is still supplied by topology/static data.",
    },
    {
        "dataset_id": "fao_wapor",
        "source_name": "FAO WaPOR",
        "provider": "FAO",
        "api_dataset": "fao_wapor",
        "temporal_resolution": "dekadal/monthly",
        "profile": "hydro",
        "output_folder": "catalog_only",
        "variables": "actual_evapotranspiration; biomass_water_productivity",
        "why_relevant": "Crop-water productivity and agricultural water-use validation.",
        "notes": "Catalog entry only; current water-use CSVs are produced by the agriculture pipeline.",
    },
    {
        "dataset_id": "fao_aquastat",
        "source_name": "FAO AQUASTAT",
        "provider": "FAO",
        "api_dataset": "fao_aquastat",
        "temporal_resolution": "annual",
        "profile": "hydro",
        "output_folder": "catalog_only",
        "variables": "water_withdrawal; irrigation_water_requirement",
        "why_relevant": "Country-scale demand calibration for drinking-water and irrigation modules.",
        "notes": "Catalog entry only; use as calibration/reference data rather than a direct simulator feed.",
    },
    {
        "dataset_id": "nile_basin_information_systems",
        "source_name": "Nile Basin information systems",
        "provider": "Nile Basin Initiative",
        "api_dataset": "nile_basin_information_systems",
        "temporal_resolution": "static",
        "profile": "core",
        "output_folder": "catalog_only",
        "variables": "reservoir_metadata; dams; basin_context",
        "why_relevant": "Nile-specific reservoir and topology assumptions.",
        "notes": "Catalog entry only; static topology and reservoir values are consolidated under horizon/data.",
    },
    {
        "dataset_id": "galileo_rinex_navigation",
        "source_name": "Galileo RINEX navigation parameters",
        "provider": "European GNSS Service Centre",
        "api_dataset": "galileo_rinex_navigation",
        "temporal_resolution": "daily/static",
        "profile": "full",
        "output_folder": "catalog_only",
        "variables": "navigation_parameters",
        "why_relevant": "EU-space provenance and optional GNSS context.",
        "notes": "Catalog entry only; not a direct simulator input.",
    },
    {
        "dataset_id": "igs_mgex",
        "source_name": "IGS MGEX data and products",
        "provider": "International GNSS Service",
        "api_dataset": "igs_mgex",
        "temporal_resolution": "daily",
        "profile": "full",
        "output_folder": "catalog_only",
        "variables": "multi_gnss_observations; troposphere_products",
        "why_relevant": "Optional GNSS water-vapour/provenance lane.",
        "notes": "Catalog entry only; access may require external credentials or archive-specific handling.",
    },
    {
        "dataset_id": "cddis_gnss_daily",
        "source_name": "CDDIS daily GNSS data",
        "provider": "NASA CDDIS",
        "api_dataset": "cddis_gnss_daily",
        "temporal_resolution": "daily",
        "profile": "full",
        "output_folder": "catalog_only",
        "variables": "rinex_observations; troposphere_zpd",
        "why_relevant": "Optional GNSS station availability and atmospheric water proxy.",
        "notes": "Catalog entry only; Earthdata credentials are usually required.",
    },
]
